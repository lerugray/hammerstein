...
the imagination + taste + direction with Ray.
...
(Ray) using game-design vocabulary, applied to AI orchestration. The
...
- Use the vocabulary in outputs to keep the framework legible to Ray
