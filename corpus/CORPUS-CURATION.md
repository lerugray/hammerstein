...
- `[GS-Ray]` — `generalstaff/docs/internal/Hammerstein Observations Log.md`
...
| 03 | The 432-files bucket-first move | clever_lazy | verification_first | [CDNA-Bot:2026-04-15 Phase 2] | high | [03-bucket-first-432-files.md](entries/03-bucket-first-432-files.md) |
...
| 07 | Boring-in-the-good-way fix verification | clever_lazy | legible_failure | [CDNA-Bot:run 19] | medium | [07-boring-in-good-way.md](entries/07-boring-in-good-way.md) |
...
| 10 | Constraint at face value (no similarity layer) | clever_lazy | bring_your_own_imagination | [CDNA-Bot:run 14 obs.1] | high | [10-constraint-at-face-value.md](entries/10-constraint-at-face-value.md) |
| 11 | The fleet-walk ceiling articulation | clever_lazy | bring_your_own_imagination | [GS-Ray:2026-04-21] | high | [11-fleet-walk-ceiling.md](entries/11-fleet-walk-ceiling.md) |
...
| 14 | Density over duration in run 22 | clever_industrious | game_design_framing | [CDNA-Bot:run 22 obs.1] | medium | [14-density-over-duration.md](entries/14-density-over-duration.md) |
| 15 | Morning planning doc paid off all day | clever_industrious | cross_project_compounding | [CDNA-Bot:<another machine> 2026-04-13 obs.4] | medium | [15-morning-planning-doc.md](entries/15-morning-planning-doc.md) |
...
| 19 | The dispatcher cycle.ts auto-merge bug | stupid_industrious | verification_first | [GS-Claude:2026-04-16 <one machine>] | high | [19-cycle-ts-auto-merge.md](entries/19-cycle-ts-auto-merge.md) |
...
| 22 | The .claude/ commit to public repo | stupid_industrious | counter_observation | [Site:entry-4] | high | [22-claude-folder-commit.md](entries/22-claude-folder-commit.md) |
...
| 24 | BaseLayout meta description repeat-failure | stupid_industrious | legible_failure | [Site:entry-6] | medium | [24-baselayout-meta-repeat.md](entries/24-baselayout-meta-repeat.md) |
| 25 | IP-boundary slip on Retrogaze | stupid_industrious | game_design_framing | [Site:entry-7] | high | [25-ip-boundary-retrogaze.md](entries/25-ip-boundary-retrogaze.md) |
| 26 | Le Rug temporal staleness | stupid_industrious | counter_observation | [Site:entry-8] | medium | [26-le-rug-temporal-staleness.md](entries/26-le-rug-temporal-staleness.md) |
| 27 | The surrogate-brain pragmatic-v0 trap | stupid_industrious | bring_your_own_imagination | [CDNA-Log:2026-04-14] | high | [27-surrogate-brain-pragmatic-trap.md](entries/27-surrogate-brain-pragmatic-trap.md) |
...
| 33 | The countCommitsAhead structural fix | clever_industrious | legible_failure | [GS-Claude:2026-04-16 <one machine> fix] | high | [33-count-commits-ahead-fix.md](entries/33-count-commits-ahead-fix.md) |
...
| 35 | Run 18 self-diagnosis unprompted | clever_lazy | legible_failure | [CDNA-Bot:run 18] | high | [35-run-18-self-diagnosis.md](entries/35-run-18-self-diagnosis.md) |
| 36 | The chrome_review_persistence loop | clever_lazy | legible_failure | [CDNA-Bot:run 11 obs.1] | high | [36-chrome-review-persistence.md](entries/36-chrome-review-persistence.md) |
| 37 | Branch-awareness bug in one cycle | clever_lazy | initial_negatives_shift | [GS-Claude:2026-04-16 first-build obs.2] | high | [37-branch-awareness-one-cycle.md](entries/37-branch-awareness-one-cycle.md) |
| 38 | Personal-site log: 8 categories in 2 days | clever_industrious | initial_negatives_shift | [Site:entries 1-8 meta] | medium | [38-personal-site-8-categories.md](entries/38-personal-site-8-categories.md) |
| 39 | The 5-free-analyses strategic conversation | clever_lazy | bring_your_own_imagination | [CDNA-Log:2026-04-13] | high | [39-five-free-analyses.md](entries/39-five-free-analyses.md) |
| 40 | <a personal-data project> as the rare exception | clever_lazy | bring_your_own_imagination | [GS-Ray:2026-04-21] | medium | [40-<a personal-data project>-exception.md](entries/40-<a personal-data project>-exception.md) |
| 41 | Cross-stream dialogue: 3 streams reading each other | clever_industrious | game_design_framing | [CDNA-Log:2026-04-13 interactive] | high | [41-cross-stream-dialogue.md](entries/41-cross-stream-dialogue.md) |
...
| 46 | Cross-project carry-over: catalogdna → GS in one day | clever_industrious | cross_project_compounding | [GS-Claude:2026-04-16 full-day obs.3] | high | [46-cross-project-carry-over.md](entries/46-cross-project-carry-over.md) |
| 47 | Initial-negatives-shift as evidence of working | clever_industrious | initial_negatives_shift | [GS-Ray:2026-04-15] | high | [47-initial-negatives-shift.md](entries/47-initial-negatives-shift.md) |
...
- **Not a benchmark.** The 5-10 benchmark questions for the v0 eval
  are a different artifact, drawn from real Ray-vs-Claude conversation
