...
**Measurable outcome:** 4 failed launch attempts (~30 min total), 18+ fast-fail bot cycles burning `consecutive_failures` budget across 13 projects, ~30 min of operator (Ray) time spent diagnosing my mistakes and killing windows.
